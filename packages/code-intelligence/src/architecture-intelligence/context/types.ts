...
export interface ContextGenerationOptions {
  ...
  /** Maximum tokens (alias for targetTokenSize) */
  maxTokens?: number;
  ...
  /** Include code (alias for includeSourceCode) */
  includeCode?: boolean;
  ...
  outputFormat?: 'markdown' | 'json' | 'text' | 'index' | 'aiccl' | 'aiccl-markdown';
  
  /** Enable minified output for smaller token usage */
  minified?: boolean;
  
  /** Enable compressed output (alias for minified) */
