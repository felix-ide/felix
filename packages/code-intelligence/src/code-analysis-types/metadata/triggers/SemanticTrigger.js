...
export class SemanticTrigger {
    ...
    matchesBusinessDomain(rule, entity, context) {
    ...
    matchesArchitecturalLayer(rule, entity, context) {
        ...
        return layers.some(layer => {
            ...
            if (layerLower === 'controller' && (entityName.includes('controller') ||
                filePath.includes('controller') ||
                filePath.includes('/api/') ||
                filePath.includes('/routes/'))) {
                return true;
            }
            if (layerLower === 'service' && (entityName.includes('service') ||
                filePath.includes('service') ||
                filePath.includes('/services/'))) {
                return true;
            }
            if (layerLower === 'model' && (entityName.includes('model') ||
            ...
            if (layerLower === 'repository' && (entityName.includes('repository') ||
    ...
    matchesCodePattern(rule, entity, context) {
        ...
        return patterns.some(pattern => {
            ...
            if (patternLower.includes('auth') && (entityName.includes('auth') ||
                entityName.includes('login') ||
                entityName.includes('token') ||
                filePath.includes('auth'))) {
                return true;
            }
            if (patternLower.includes('crud') && (entityName.includes('create') ||
...
//# sourceMappingURL=SemanticTrigger.js.map